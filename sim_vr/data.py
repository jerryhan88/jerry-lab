...
def Network1(PRT_SPEED, S2J_SPEED, J2D_SPEED):
    ...
    C_len = [0, 21000, 15000, 20000, 23000, 18000, 20000]
    C = [sum(C_len[:i + 1]) for i in range(len(C_len))]
    
    R_len = [0, 15000, 18000, 16000, 21000]
    ...
    Edges.append(Edge(findN('0E'), findN('1W'), PRT_SPEED))
    Edges.append(Edge(findN('1E'), findN('2W'), PRT_SPEED))
    Edges.append(Edge(findN('6S'), findN('13N'), PRT_SPEED))
    Edges.append(Edge(findN('16W'), findN('15E'), PRT_SPEED))
    Edges.append(Edge(findN('15W'), findN('14E'), PRT_SPEED))
    Edges.append(Edge(findN('16W'), findN('15E'), PRT_SPEED))
    Edges.append(Edge(findN('10N'), findN('3S'), PRT_SPEED))
    Edges.append(Edge(findN('8W'), findN('7E'), PRT_SPEED))
    Edges.append(Edge(findN('12N'), findN('5S'), PRT_SPEED))
        ...
        if JD2N: 
            ...
            for i, n in enumerate(JD2N):
                if i == len(JD2N) - 1:
                    ...
                    break
                Edges.append(Edge(JD2N[i], JD2N[i + 1], J2D_SPEED))
...
def Network2(S2J_SPEED, J2D_SPEED):
    from Dynamics import Node, Edge, TRANSFER, STATION, JUNCTION, DOT
