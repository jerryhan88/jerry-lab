...
class Process_info_Viewer(wx.Dialog):
    def __init__(self, selected_process):
        ...
        search_btn = wx.BitmapButton(search_p, -1, bitmap=wx.BitmapFromImage(search_img), pos=(search_input_px + search_input_sx + 3, search_input_py))
        self.Bind(wx.EVT_BUTTON, self.search, search_btn)
        
        self.partner_finder = wx.ScrolledWindow(self, -1, pos=(repo_p_px, repo_p_py + repo_p_sy + 40),
...
#        self.Bind(wx.EVT_BUTTON, self.confirm, button)
    ...
    def drawing_partner(self, _):
        ...
        if self.selected_partner ==2:
            ...
            p3 = (4-2, 5+95*2+15+2+100)
            p4 = (4+2+319, 5+95*2+15+2+100)
