...
#    print 'len([n for n in all_nodes if n.visited]) : ',len([n for n in all_nodes if n.visited])
...
#        print [(n.id,n.order, n.E_T, n.L_T)for n in todo]
        n = todo.pop()
#        print 'del node : ', (n.id, n.order, n.L_T)
...
#            if cur_yt.stop_position:
#                print 'cur_vehicle.position : ', cur_yt.stop_position.id
#            else:
#                print 'cur_vehicle.position : ', cur_yt.stop_position
            print ''
