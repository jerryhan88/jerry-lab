...
v1 = generator.Vessel_information(master.vt_group['vt1'], 'Regina Maersk', distr.CONST(7), distr.CONST(2), distr.CONST(5), (13, 15))
v2 = generator.Vessel_information(master.vt_group['vt1'], 'Louis Maersk', distr.CONST(14), distr.CONST(3), distr.CONST(6), (15, 18))
v3 = generator.Vessel_information(master.vt_group['vt3'], 'Tokyo Bay', distr.EXPO(7.0), distr.CONST(2), distr.CONST(5), (12, 16))

v1.set_cargo_character(Through=('Dry',distr.CONST(3)), Import=('Dry', distr.CONST(2), 'A'), Export=('Dry',distr.CONST(2), 'B'),
                                     Trans={'Louis Maersk' : ('Dry',distr.CONST(1), 'C'), 'Tokyo Bay' : ('Dry',distr.CONST(1), 'E')})
v2.set_cargo_character(Through=('Dry',distr.CONST(2)), Import=('Dry',distr.CONST(1), 'A'), Export=('Dry',distr.CONST(1), 'D'),
                                     Trans={'Regina Maersk':('Dry',distr.CONST(3), 'C'), 'Tokyo Bay':('Dry',distr.CONST(1), 'B')})
v3.set_cargo_character(Through=('Dry',distr.CONST(1)), Import=('Dry',distr.CONST(4), 'A'), Export=('Dry',distr.CONST(3), 'C'),
                                     Trans={'Louis Maersk' : ('Dry',distr.CONST(2), 'B')})
