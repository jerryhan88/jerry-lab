...
class Notice_Viewer(wx.Dialog):
    ...
    def add_more_information(self, info, x, y):
        wx.StaticText(self, -1, info, (x, y))
...
class Arriving_Event_Viewer(wx.Dialog):
    def __init__(self, parent, name, size=(640, 800), pos=(40, 40)):
        ...
        stowage = wx.CheckBox(self, -1, "Stowage", pos=(30, 20))
        stowage.SetValue(True)
        COPINO = wx.CheckBox(self, -1, "COPINO", pos=(160, 20))
        va_notice = wx.CheckBox(self, -1, "Vessel arrival Notice", pos=(330, 20))
    
        self.Bind(wx.EVT_CHECKBOX, self.On_stowage, stowage)
        self.Bind(wx.EVT_CHECKBOX, self.On_COPINO, COPINO)
        self.Bind(wx.EVT_CHECKBOX, self.On_va_notice, va_notice)
    ...
    def On_stowage(self, evt):
        print 'stowage'
            
    def On_COPINO(self, evt):
        pass
        
    def On_va_notice(self, evt):
        pass
...
#                before_arrival_SP_list = [aContainer.ID for aContainer in g.traverse(Class.before_arrival_SP)]
    ...
    '''  
                ...
                for s, x, y in [(s_info, 100, 65), (s_current, 140, 10)]:        
                    vessel_arrival_notice.add_more_information(s, x, y)    
    ...
    '''
                ...
                for s, x, y in [(s_info, 100, 65), (s_current, 140, 10)]:        
                    COPINO_notice.add_more_information(s, x, y)    
